...
- **<!--devops:count:hooks-->57<!--/devops:count:hooks--> Hooks** — automated guards and triggers across the full session lifecycle
...
<!--devops:count:hooks-->57<!--/devops:count:hooks--> hooks fire automatically across the session lifecycle — no user action needed.
...
├── hooks/                         ← <!--devops:count:hooks-->57<!--/devops:count:hooks--> hooks (JS) registered in hooks.json
