...
1. Read `~/.claude/skills/commit/SKILL.md` + `reference.md` if exists → global overrides
2. Read `{project}/.claude/skills/commit/SKILL.md` + `reference.md` if exists → project overrides
