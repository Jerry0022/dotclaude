...
process.stdin.on('end', () => {
  ...
  lines.push(
    ...
    '  aborted=task aborted/infeasible/rate-limited, test=code edits+app relevant, test-minimal=user started app no edits yet,',
    '  ready=code/doc changes (>=1 edit) no app, analysis=no file changes (explanation/investigation), fallback=other.',
