...
description: >-
  ...
  Use proactively, in the background, to run the full test suite or build verification after non-trivial code changes, and after 2+ fix passes on the same bug — no user request needed.
