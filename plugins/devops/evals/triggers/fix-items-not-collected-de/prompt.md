...
tags: [trigger, skill-fix, lang-de]
env: { EVAL_DOTCLAUDE_BUDGET: free }
---

Viel besser! Allerdings wenn ich von A1 zu A2 wandere, dann fährt auch das schiff, aber items werden nicht mehr eingesammelt
