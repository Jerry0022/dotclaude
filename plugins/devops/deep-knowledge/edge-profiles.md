...
| When triggered | Any test / browser task | `get_usage` / the completion card (`--no-login`), or a manual usage refresh (`deep-knowledge/usage.md`) |
...
| Usage data (automatic + manual path) | [usage.md](usage.md) |
