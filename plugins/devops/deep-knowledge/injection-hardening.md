...
critical in **unsupervised** runs (do-run autonomous mode) where no human reviews a
bad call mid-flight.
...
In do-run autonomous mode the asymmetry is the whole problem: the outbound legs are
