...
- Global: `~/.claude/skills/auto-concept/SKILL.md` + `reference.md`
- Project: `{project}/.claude/skills/auto-concept/SKILL.md` + `reference.md`
...
- Output directory: `docs/devops-concepts/` (instead of `.claude/concept/`)
