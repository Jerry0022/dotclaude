...
description: >-
  ...
  for debugging (use /debug) or research (use /devops-deep-research).
...
1. Global: `~/.claude/skills/explain/SKILL.md` + `reference.md`
2. Project: `{project}/.claude/skills/explain/SKILL.md` + `reference.md`
