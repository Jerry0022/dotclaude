...
allowed-tools: >-
  ...
  mcp__plugin_dotclaude-dev-ops_dotclaude-completion__*,
  mcp__plugin_dotclaude-dev-ops_dotclaude-ship__*,
  mcp__plugin_dotclaude-dev-ops_dotclaude-issues__*
---
...
- **Complex**: use dotclaude-dev-ops agent roster (core, frontend, ai, qa, designer)
