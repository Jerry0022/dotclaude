...
| prototype | Approve screen/flow | Flag for redesign |
...
`{project}/.claude/livebrief/{same-timestamp}-{same-slug}-decisions.json`
...
- Clean up HTML files periodically (suggest during `/repo-health`)
