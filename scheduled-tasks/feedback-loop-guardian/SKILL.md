...
- Cron: */30 * * * *
- Recurring: true
- Prompt: (die vollständige Feedback-Loop v2.2 Anweisung):

Feedback-Loop v2.2 — führe diese 5 Schritte der Reihe nach aus:
